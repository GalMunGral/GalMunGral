...
\begin{itemize}
\item \href{https://galmungral.github.io/polyrender}{A GPU-accelerated 2D vector graphics renderer (TypeScript, WebGL) \hfill \texttt{/polyrender}}
\item \href{https://galmungral.github.io/mercator?lon=-73.9855&lat=40.7580}{A basic raster map tile renderer (TypeScript) \hfill \texttt{/mercator}}
...
\item \href{https://github.com/galmungral/replay}{A VDOM-based front-end framework with a module bundler (TypeScript) \hfill \texttt{/replay}}
\end{itemize}
